...
category: "Ops"
description: "Learn what transformational leadership is, how Burns and Bass shaped it, the Four I's, what the evidence shows, and where the model falls short."
metadata:
  ...
  image: "/images/scenes/graphite/windmill-row-colour-light.webp"
---
...
```mermaid
flowchart LR
  A[Downton uses the term] --> B[Burns publishes Leadership]
  B --> C[Bass defines the Four I's]
  C --> D[Behaviors measured in research]
  D --> E[Modern applied model]
```
