...
### Reach: Build Awareness Across Channels

The Reach stage focuses on driving visibility among your target audience through paid, owned, and earned media. The goal is to maximize relevant traffic and brand awareness at the top of the customer journey funnel. KPIs include unique visitors, impressions, share of voice, and cost per reach. Success here depends on audience research, keyword strategy, and channel selection aligned to where your ideal buyers spend attention.

### Act: Encourage Meaningful Interactions

Act — short for 'Interact' — corresponds to the consideration stage of the buyer journey. It measures how effectively you engage visitors once they arrive. This includes content consumption, social sharing, lead form completions, and product exploration. The principle is that not every visitor is ready to buy; Act stage tactics nurture interest through valuable content, interactive tools, and personalized experiences that move prospects deeper into the funnel.

### Convert: Drive Purchases or Lead Generation

The Convert stage maps to the decision stage of the customer journey, where prospects become customers. Activities include conversion rate optimization, retargeting, checkout UX improvements, pricing experiments, and sales enablement. KPIs center on conversion rate, cost per acquisition, revenue per visit, and average order value. This stage demands tight alignment between marketing and sales to reduce friction at the critical moment of commitment.

### Engage: Foster Loyalty and Advocacy

Engage addresses the post-purchase customer journey — retention, repeat purchases, and advocacy. Tactics include email nurture sequences, loyalty programs, community building, personalized recommendations, and customer success outreach. KPIs include customer lifetime value, Net Promoter Score, repeat purchase rate, and churn rate. This stage recognizes that acquiring a customer is only the beginning; long-term profitability depends on deepening the relationship.

### Plan: Ground Tactics in Strategy

Before executing RACE, a planning phase ensures every activity is anchored to business goals, audience insights, and competitive analysis. This includes defining target personas, conducting a digital marketing audit, setting SMART objectives for each customer journey stage, and allocating budget based on opportunity gaps. Without the Plan phase, RACE becomes a checklist rather than a strategic framework.

### Integration Across Stages

RACE is not four siloed programs — it is a connected system. Data from one stage informs optimization at another. Engagement insights refine Reach targeting; Act-stage behavior predicts Convert-stage outcomes. This integration principle ensures the customer journey is managed holistically, with shared dashboards, unified attribution, and cross-functional ownership eliminating the handoff gaps that plague most marketing organizations.

### Continuous Measurement and Optimization

Each RACE stage has defined KPIs that feed a cycle of measurement, analysis, and improvement. The framework encourages regular customer journey analysis — weekly, monthly, and quarterly reviews — to identify bottlenecks, reallocate resources, and test new approaches. This data-driven discipline transforms RACE from a static plan into a living system that adapts to market changes and customer behavior shifts.
...
- [Setting KPIs and Metrics Across Each RACE Stage](../../skills/setting-kpis-across-race-stages/SKILL.md) — How to define measurable objectives and key performance indicators for awareness, interaction, conversion, and retention stages of the RACE model.
- [Building RACE Digital Marketing Planning Templates](../../skills/building-race-planning-templates/SKILL.md) — How to create actionable planning templates and spreadsheets that organize objectives, tactics, channels, and KPIs across all four RACE stages.
- [Mapping Customer Journey Stages to the RACE Funnel](../../skills/mapping-customer-journey-stages-to-race/SKILL.md) — How to align each RACE stage (Reach, Act, Convert, Engage) with corresponding customer journey stages to ensure full-funnel coverage.
- [Building Awareness in the Reach Stage](../../skills/building-awareness-in-the-reach-stage/SKILL.md) — How to select and optimize channels and tactics—SEO, paid media, social—to maximize audience reach at the top of the customer journey funnel.
- [Driving Interactions in the Act (Consideration) Stage](../../skills/driving-interactions-in-the-act-stage/SKILL.md) — How to design content, landing pages, and engagement tactics that move prospects from awareness to active consideration and interaction with your brand.
- [Optimizing the Full-Funnel Customer Journey with RACE](../../skills/optimizing-the-full-funnel-customer-journey/SKILL.md) — How to analyze performance data across all RACE stages to identify drop-off points, reallocate budget, and continuously improve the end-to-end customer journey.
- [Creating Customer Journey Maps Using the RACE Framework](../../skills/creating-race-customer-journey-maps/SKILL.md) — How to build a visual customer journey map organized by RACE stages, including touchpoints, channels, content, and buyer intent at each phase.
- [Optimizing Conversions in the Convert (Decision) Stage](../../skills/optimizing-conversions-in-the-convert-stage/SKILL.md) — How to apply conversion rate optimization techniques, retargeting, and persuasion tactics to turn engaged prospects into customers at the decision stage.
