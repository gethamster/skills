...
The term and the first systematic study come from the paper by [Aggarwal and colleagues](https://arxiv.org/abs/2311.09735) at Princeton and IIT Delhi, published at KDD. They defined visibility metrics for generative engine responses, built the GEO-bench benchmark, and tested nine ways of editing source content. The paper is the research origin of optimizing content for generated answers.
