...
Scrum is founded on empiricism — the idea that knowledge comes from experience and decisions should be based on what is observed. The three pillars of transparency, inspection, and adaptation ensure that teams continuously learn from real outcomes rather than relying on predictions. Every sprint produces observable results that inform the next cycle of planning.

### Time-Boxed Sprints

All work in scrum occurs within sprints — fixed-length iterations of one to four weeks. Time-boxing creates urgency, limits work-in-progress, and ensures regular delivery of potentially shippable increments. The consistent cadence builds team rhythm and provides predictable opportunities for stakeholders to inspect progress and provide feedback.

### Self-Managing Cross-Functional Teams

Scrum teams are structured to contain all the skills necessary to deliver a product increment without depending on external resources. Within the boundaries set by the sprint goal, developers self-manage — deciding how to accomplish the work, distributing tasks, and holding each other accountable. This autonomy drives ownership, creativity, and faster decision-making.

### Clear Roles and Accountabilities

Scrum defines three distinct accountabilities: the Product Owner owns the 'what' by managing and prioritizing the product backlog; the Scrum Master owns the 'how' of scrum adoption by coaching the team and removing impediments; and the Developers own the execution by building each sprint's increment. These clear boundaries eliminate confusion and distribute authority effectively.

### Incremental Value Delivery

Each sprint must produce a Done increment — a usable piece of the product that adds value. By delivering working product frequently, scrum teams reduce risk, gather real user feedback early, and create opportunities for the organization to realize value before the full product is complete. The increment builds cumulatively on all prior increments.

### Continuous Improvement Through Retrospectives

The sprint retrospective is the engine of scrum's continuous improvement cycle. At the end of every sprint, the team inspects its own process, relationships, and tools to identify what went well, what didn't, and what to change. The most impactful improvements are added to the next sprint backlog, ensuring that process refinement is treated as real, prioritized work.

### Scrum Values

Five values underpin every scrum implementation: commitment (to achieving team goals), focus (on the sprint's work), openness (about challenges and progress), respect (for each team member's capabilities), and courage (to do the right thing and tackle tough problems). These values create the trust and psychological safety that empiricism requires to function.
...
- [Defining Scrum Roles and Accountabilities](../../skills/defining-scrum-roles-and-accountabilities/SKILL.md) — How to clearly establish and operate within the Product Owner, Scrum Master, and Development Team roles as defined by the Scrum framework.
- [Facilitating Sprint Retrospectives](../../skills/facilitating-sprint-retrospectives/SKILL.md) — How to lead retrospective meetings that surface actionable improvements and foster a culture of continuous team learning.
- [Grooming and Refining the Product Backlog](../../skills/grooming-the-product-backlog/SKILL.md) — How to continuously prioritize, estimate, and refine backlog items so they are sprint-ready with clear acceptance criteria.
- [Planning and Executing Sprints](../../skills/planning-and-executing-sprints/SKILL.md) — How to scope, plan, and run time-boxed sprints including backlog selection, capacity planning, and sprint goal setting.
- [Estimating Work with Story Points and Planning Poker](../../skills/estimating-work-with-story-points/SKILL.md) — How to use relative estimation techniques like story points and planning poker to forecast sprint capacity and improve predictability.
- [Running Effective Daily Stand-Up Meetings](../../skills/running-daily-standups/SKILL.md) — How to facilitate focused, time-boxed daily scrum meetings that surface blockers and align the team on sprint goals.
- [Conducting Sprint Reviews and Demos](../../skills/conducting-sprint-reviews/SKILL.md) — How to run effective sprint review meetings that demonstrate working increments to stakeholders and gather actionable feedback.
- [Managing Scrum Boards in Jira](../../skills/managing-scrum-boards-in-jira/SKILL.md) — How to set up and manage Jira scrum boards, configure workflows, track velocity, and generate burndown charts for sprint visibility.
