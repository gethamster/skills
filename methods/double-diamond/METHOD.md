...
name: "double-diamond"
category: "Experience"
description: "The Double Diamond is the Design Council's four-phase design process: Discover, Define, Develop, Deliver. Learn how to run it and when to skip it."
metadata:
...
> Created by **Design Council** - [https://www.designcouncil.org.uk/our-resources/the-double-diamond/](https://www.designcouncil.org.uk/our-resources/the-double-diamond/)

## Overview

The Double Diamond is a picture of the design process drawn as two diamonds side by side, split into four phases: Discover, Define, Develop and Deliver. It comes from the Design Council, the UK's national strategic advisor for design, which describes the two diamonds as a process of exploring an issue more widely or deeply (divergent thinking) and then taking focused action (convergent thinking) in its [Framework for Innovation](https://www.designcouncil.org.uk/resources/framework-for-innovation/). The first diamond works on the problem. The second works on the solution. Each diamond opens out and then closes, so a team goes wide twice and narrows twice before anything ships.

The model grew out of a practical question. According to the Design Council's [history of the Double Diamond](https://www.designcouncil.org.uk/resources/the-double-diamond/history-of-the-double-diamond/), in 2003 its Director of Design and Innovation, Richard Eisermann, asked his team how to describe design process, because the organisation was promoting design management while lacking a shared description of the work. A group of Design Council staff and independent design strategists produced four phases and chose alliterative names on purpose so people would remember them. The Design Council began sharing the diagram at conferences and in presentations in 2004, [its history page says](https://www.designcouncil.org.uk/resources/the-double-diamond/history-of-the-double-diamond/), and its 2007 research report on managing design was structured around it.

That report is where many secondary sources get their dates. The Design Council's [Eleven lessons study](https://www.designcouncil.org.uk/fileadmin/uploads/dc/Documents/ElevenLessons_Design_Council%2520%25282%2529.pdf) interviewed the design heads of eleven companies in 2007 and states that the diagram was developed through in-house research in 2005. So the study applied an existing model to what it found; it did not produce the model. The Design Council's own current pages give 2003 for the work and 2004 for the launch, and this page follows them. The diverge-then-converge shape itself is older: the [Wikipedia entry](https://en.wikipedia.org/wiki/Double_Diamond_%28design_process_model%29) traces it to a 1996 divergence-convergence model by the systems scientist Béla H. Bánáthy.

In 2019 the Design Council placed the diagram inside a larger Framework for Innovation. Its [2019 framework diagram](https://www.designcouncil.org.uk/fileadmin/uploads/dc/Documents/Case_Studies_Documents/Double_Diamond_Model_2019.pdf) keeps the four phases between a challenge and an outcome and adds four design principles, a methods bank organised as explore, shape and build, and two conditions around the process: leadership and engagement. The framework diagram also carries arrows that loop back, and the Design Council says plainly that "this is not a linear process."
...
Each diamond starts by widening the set of options and ends by narrowing it. The Design Council's [Framework for Innovation](https://www.designcouncil.org.uk/resources/framework-for-innovation/) describes the two modes as exploring an issue widely or deeply, then taking focused action. The order matters because convergence can only choose among the options that divergence produced. A team that narrows first ends up choosing from a short list it never questioned.

### Separate the problem from the solution

The first diamond ends with a definition of the problem, and only then does solution work begin. The Design Council says the first diamond "helps people understand, rather than simply assume, what the problem is" on its [Double Diamond page](https://www.designcouncil.org.uk/our-resources/the-double-diamond/). Holding the two apart gives the team a stable target to judge ideas against. When ideas are debated before the problem is agreed, people are usually arguing about different problems.

### Put people first

The framework's first design principle is to start with an understanding of the people using a service, their needs, strengths and aspirations. In practice this means Discover involves speaking to and spending time with the people affected, as the [framework page](https://www.designcouncil.org.uk/resources/framework-for-innovation/) puts it. Desk research and internal opinion are inputs, but they do not replace contact with users. A phase that produced no new evidence about people has not done its job.

### Communicate visually and inclusively

The second principle asks teams to help people gain a shared understanding of the problem and the ideas. Journey maps, sketches, prototypes and the diamond diagram itself are the usual vehicles, because a picture can be checked and corrected by people outside the design team. The [2019 framework diagram](https://www.designcouncil.org.uk/fileadmin/uploads/dc/Documents/Case_Studies_Documents/Double_Diamond_Model_2019.pdf) lists this principle as "Communicate (Visually and Inclusively)." Visible work also makes it obvious when two stakeholders hold different pictures of the same project.
...
## Double Diamond Compared With Related Models

| Model | Phases | Source |
|---|---|---|
| Double Diamond | Discover, Define, Develop, Deliver | [Design Council framework](https://www.designcouncil.org.uk/resources/framework-for-innovation/) |
| d.school design thinking | Empathize, Define, Ideate, Prototype, Test | [d.school Bootleg](https://dschool.stanford.edu/resources/design-thinking-bootleg) |
| NN/g design thinking | Empathize, Define, Ideate, Prototype, Test, Implement | [NN/g Design Thinking 101](https://www.nngroup.com/articles/design-thinking/) |
| GOV.UK service phases | Discovery, alpha, beta, live | [GOV.UK discovery guidance](https://www.gov.uk/service-manual/agile-delivery/how-the-discovery-phase-works) |
| Revamped Double Diamond | Research, Synthesis, Ideation, Implementation | [Dan Nessler](https://marvelapp.com/blog/apply-design-thinking-hcd-ux-creative-process-scratch/) |
...
- [Conducting Discovery Research in the Double Diamond](../../skills/conducting-discovery-research/SKILL.md): Plan and run the Discover phase with interviews, observation and desk research.
- [Synthesizing Insights to Define the Problem](../../skills/synthesizing-problem-definitions/SKILL.md): Turn discovery findings into themes, insights and an agreed problem statement in Define.
- [Facilitating Divergent Ideation in the Double Diamond](../../skills/facilitating-divergent-ideation/SKILL.md): Run ideation and co-design sessions that produce distinct solution concepts in Develop.
- [Converging on Final Solutions in the Deliver Phase](../../skills/converging-on-final-solutions/SKILL.md): Test, compare and narrow concepts to one solution ready for Deliver.
- [Double Diamond Thinking: Divergent and Convergent Modes](../../skills/mapping-divergent-convergent-thinking/SKILL.md): Tell a team which thinking mode each session needs and manage the switch between them.
- [How to Create a Double Diamond Diagram](../../skills/diagramming-the-double-diamond/SKILL.md): Draw a project-specific diagram that shows phases, activities and current position.
- [Double Diamond vs Design Thinking: Choosing a Framework](../../skills/choosing-between-double-diamond-and-design-thinking/SKILL.md): Compare the model with d.school design thinking and Lean UX and pick one for a project.
- [Adapting the Double Diamond UX Framework for Design Projects](../../skills/adapting-double-diamond-for-ux-projects/SKILL.md): Map the four phases onto UX research, wireframing and usability testing work.

## FAQ

**What is the difference between the Double Diamond and design thinking?**

Both describe a human-centred process that alternates between exploring and deciding. The Double Diamond uses four phases and draws the widening and narrowing explicitly. The d.school's [design thinking modes](https://dschool.stanford.edu/resources/design-thinking-bootleg) are Empathize, Define, Ideate, Prototype and Test, presented as tools you can start with anywhere. Many teams use the diamond to plan a project and design thinking methods inside each phase.

**Who created the Double Diamond, and when?**

The Design Council in the UK. Its [history page](https://www.designcouncil.org.uk/resources/the-double-diamond/history-of-the-double-diamond/) says the work began in 2003 under Richard Eisermann and that the diagram was first shared publicly in 2004. The Council's 2007 [Eleven lessons report](https://www.designcouncil.org.uk/fileadmin/uploads/dc/Documents/ElevenLessons_Design_Council%2520%25282%2529.pdf) gives 2005 as the development date, so older articles often cite that year.

**What did the Framework for Innovation add?**

The Design Council kept the four phases and placed them inside a wider framework. The [2019 diagram](https://www.designcouncil.org.uk/fileadmin/uploads/dc/Documents/Case_Studies_Documents/Double_Diamond_Model_2019.pdf) adds four design principles, a methods bank (explore, shape, build), and leadership and engagement as the conditions around the process. It also draws arrows looping back to show that the process is not linear.
...
No. The Design Council states on its [framework page](https://www.designcouncil.org.uk/resources/framework-for-innovation/) that it is not a linear process, and that organisations often learn something that sends them back to the beginning. Early prototypes can also be part of Discover. Use the diagram to show where the project's centre of gravity is, and expect to move backward when evidence requires it.

**Can I use the Double Diamond with agile delivery?**

Yes. Many teams run the first diamond as a discovery period before committing a delivery team, then run Develop and Deliver in iterations. The UK government's [service phases](https://www.gov.uk/service-manual/agile-delivery/how-the-discovery-phase-works) follow a similar arc and add an explicit decision at the end of discovery about whether to continue. The key is to keep the problem definition visible while sprints focus on solutions.

**Can I reuse the Double Diamond diagram in my own materials?**

The Design Council publishes the Framework for Innovation under a CC BY 4.0 licence, according to its [framework page](https://www.designcouncil.org.uk/resources/framework-for-innovation/). That licence allows reuse and adaptation with attribution. Credit the Design Council when you redraw or adapt it.
...
- [Design Council: Framework for Innovation diagram](https://www.designcouncil.org.uk/fileadmin/uploads/dc/Documents/Case_Studies_Documents/Double_Diamond_Model_2019.pdf)
