...
Each diamond begins with a divergent phase (opening up) before moving to a convergent phase (narrowing down). This structure prevents premature decision-making and ensures teams explore the full landscape of possibilities — whether that's the problem space or the solution space — before committing to a direction.

### Separate Problem and Solution

The two diamonds enforce a critical separation between understanding the problem and designing the solution. The first diamond is entirely dedicated to exploring and defining the right problem. Only after a clear problem definition is established does the team enter the second diamond to generate and refine solutions. This prevents solutioning bias.

### Be People-Centred

The double diamond framework is rooted in human-centred design. Every phase — from initial discovery research to final delivery — should be grounded in empathy for the people who will be affected by the design. User needs, behaviours, and contexts drive decisions rather than assumptions or internal politics.

### Communicate Visually and Collaboratively

The framework encourages teams to make their thinking visible through diagrams, journey maps, prototypes, and other artifacts. This visual communication enables cross-functional collaboration and ensures that diverse perspectives are integrated throughout the process.

### Iterate Relentlessly

While the double diamond appears linear, real design work involves constant iteration. Teams cycle back through phases as they learn new information. A prototype test in Deliver might reveal that the problem definition needs refining, sending the team back to the first diamond. The model is a guide, not a rigid sequence.

### Evidence Over Assumption

At every convergent moment — moving from Discover to Define, or from Develop to Deliver — teams should base their decisions on evidence gathered during the preceding divergent phase. Research findings, user feedback, and test results replace gut feelings and HiPPO (highest-paid person's opinion) decision-making.
...
- [Converging on Solutions in the Deliver Phase](../../skills/converging-on-final-solutions/SKILL.md) — How to evaluate, test, and iterate on concepts to select and refine the final solution for implementation in the Deliver phase.
- [Synthesizing Insights to Define the Problem](../../skills/synthesizing-problem-definitions/SKILL.md) — How to apply convergent thinking in the Define phase to analyze discovery findings, create problem statements, and narrow focus to the right challenge.
- [Facilitating Divergent Ideation in the Develop Phase](../../skills/facilitating-divergent-ideation/SKILL.md) — How to run structured brainstorming, co-design workshops, and prototyping sessions to generate a wide range of potential solutions in the second diamond.
- [Mapping Divergent and Convergent Thinking Modes](../../skills/mapping-divergent-convergent-thinking/SKILL.md) — How to deliberately switch between expansive exploration and focused decision-making at each stage of the Double Diamond process.
- [Conducting Discovery Research in the Discover Phase](../../skills/conducting-discovery-research/SKILL.md) — How to use divergent thinking techniques like user interviews, desk research, and observation to broadly explore the problem space in the first diamond.
- [Creating Double Diamond Process Diagrams](../../skills/diagramming-the-double-diamond/SKILL.md) — How to visually map your design process onto the Double Diamond diagram to communicate project phases, activities, and progress to stakeholders.
- [Choosing Between Double Diamond and Design Thinking](../../skills/choosing-between-double-diamond-and-design-thinking/SKILL.md) — How to compare the Double Diamond with other design frameworks like Stanford d.school Design Thinking and Lean UX to select the right approach for your project.
- [Adapting the Double Diamond for UX Design Projects](../../skills/adapting-double-diamond-for-ux-projects/SKILL.md) — How to apply the Double Diamond framework specifically to UX workflows, integrating user research, wireframing, usability testing, and iterative design.
