...
| Time to Learn | 1-2 hours for the session itself, plus 30-60 minutes of preparation |
...
| Prerequisites | Understanding of the Shape Up cycle structure (shaping, betting, building, cool-down), At least 2-3 shaped pitches ready for review (see shaping-product-pitches), Familiarity with the concept of appetites and fixed time, variable scope, Knowledge of available teams and their capacity for the upcoming cycle |
...
### Step 1: Step 1: Set the Cycle Context Before Anything Else
...
> **Pro tip:** Write the constraints on a shared screen or whiteboard where everyone can see them throughout the session. When debates stall, point back to the constraints. They resolve most disagreements faster than discussion.

### Step 2: Step 2: Distribute Shaped Pitches 24-48 Hours Before the Session
...
> **Pro tip:** If you have more than 5-6 pitches, flag the 2-3 that the shaping team considers strongest. This is not to bias the decision but to help participants allocate their pre-read attention. People will skim if everything looks equal.

### Step 3: Step 3: Present Each Pitch with a Strict Time Box
...
> **Pro tip:** Use a visible timer. When discussion runs long on one pitch, it almost always means the pitch is not shaped well enough. Note the concern, table it, and move on. You can revisit after all pitches have been heard.

### Step 4: Step 4: Surface Risks and Rabbit Holes Explicitly
...
> **Pro tip:** Ask the most skeptical person at the table to speak first on risks. If the CTO thinks something is straightforward, ask the designer. If the designer is confident, ask about data or compliance. Optimism bias is the biggest risk at a betting table.

### Step 5: Step 5: Make the Bet or Pass Decision for Each Pitch
...
> **Pro tip:** If a pitch is a pass, say so clearly and move on. Do not spend 15 minutes softening the rejection. The pitch author is usually not at the table, and even if they are, a clean pass with a clear reason is more respectful than a vague deferral.

### Step 6: Step 6: Match Bets to Specific Teams
...
> **Pro tip:** If possible, let teams have some input on which bet they take. A team that is excited about a problem will outperform a team that was assigned one. But do not let this devolve into a negotiation. The table decides, and team preference is one input among several.

### Step 7: Step 7: Document and Communicate the Cycle Plan
...
> **Pro tip:** Include the pitches that were passed on in the communication. This prevents people from lobbying to sneak rejected work into the cycle and demonstrates that the betting table takes all proposals seriously even when it says no.

### Step 8: Step 8: Close the Table and Protect the Cycle
...
> **Pro tip:** Establish a clear escalation path for genuine emergencies before the cycle starts. If someone has to make a judgment call about pulling a team off a bet, decide in advance who has that authority. It should be the same person who ran the betting table.
...
- **Allowing scope to creep into bets after the table closes, treating the cycle plan as a starting point rather than a commitment.** — Post-table scope additions are a symptom of insufficient trust in the process. " The facilitator must protect the cycle boundary aggressively. " If you allow exceptions, you teach the organization that the betting table is advisory, not authoritative, and participation and preparation quality will decline. Track how often mid-cycle additions happen.

If it is frequent, the root cause is usually insufficient shaping, because important aspects were missed before the table.
- **Spending the entire session on the first one or two pitches and rushing through the rest.** — This happens when the facilitator does not enforce time boxes. The first pitch gets a thorough, thoughtful discussion. The second pitch gets a good review. By the fourth pitch, people are fatigued and just want to finish.
