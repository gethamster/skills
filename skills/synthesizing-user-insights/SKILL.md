---
name: "synthesizing-user-insights"
description: "Turn raw observations and interviews into a small set of evidence-backed, testable insights that a team can frame problems and ideas around."
category: "Experience"
metadata:
...
```mermaid
flowchart LR
  A[Raw observations] --> B[Clustered patterns]
  B --> C[Interpretations]
  C --> D[Testable insights]
  D -.->|check against| A
```
