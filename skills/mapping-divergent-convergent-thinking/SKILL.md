...
| Prerequisites | Basic understanding of the Double Diamond framework and its four phases, Familiarity with facilitation or workshop techniques, Experience participating in at least one design or product discovery process |
...
This skill is foundational to the [Double Diamond](https://tryhamster.com/methods/double-diamond) method and directly supports sibling skills like [conducting discovery research](https://tryhamster.com/skills/conducting-discovery-research) (a divergent activity) and [converging on final solutions](https://tryhamster.com/skills/converging-on-final-solutions) (a convergent activity). Master the mode map first, and every other Double Diamond skill becomes dramatically more effective.
...
### Step 1: Step 1: Audit Your Current Process for Mode Awareness
...
> **Pro tip:** Interview 2-3 team members separately about where they felt frustrated in recent projects. Frustration often signals a mode mismatch—someone wanting to explore while the group is converging, or vice versa.

### Step 2: Step 2: Create a Visual Mode Map for Your Double Diamond
...
> **Pro tip:** Use color coding—green for divergent phases and red for convergent phases—to create an immediate visual signal that even newcomers understand at a glance.

### Step 3: Step 3: Define Explicit Rules of Engagement for Each Mode
...
> **Pro tip:** Laminate the rules or create a digital card that facilitators can literally hold up when mode violations occur. Physical signals are more effective than verbal corrections.

### Step 4: Step 4: Design Transition Rituals Between Modes
...
> **Pro tip:** Some teams find it helpful to physically change the room setup at transitions—rearranging chairs from circles (diverge) to rows facing a screen (converge)—to trigger a cognitive shift.

### Step 5: Step 5: Assign a Mode Guardian for Each Session
...
> **Pro tip:** Give the mode guardian a physical prop—a colored flag, a bell, or even an emoji reaction in virtual meetings—so interventions feel playful rather than punitive.

### Step 6: Step 6: Calibrate Timebox Ratios for Each Mode
...
> **Pro tip:** Track actual time spent in each mode across multiple projects. Most teams discover they under-invest in divergent phases by 30-40%, which explains why their solutions feel incremental rather than innovative.

### Step 7: Step 7: Retrospect on Mode Discipline After Each Project
...
- **Allowing critique during divergent phases ('That won't work because…')** — Enforce a strict 'capture everything' rule during divergent phases. Park feasibility concerns on a separate list to address during the convergent phase. Even one premature critique can shut down creative exploration for the entire group.
- **Treating convergence as simply voting or picking favorites** — Convergence requires evaluation criteria defined before you start filtering. Use structured techniques like weighted scoring matrices, impact/effort mapping, or How-Might-We clustering. 'I like this one' is not convergence—it's preference without rigor.
- **Skipping the Define phase and jumping from Discover directly to Develop** — This is the single most common Double Diamond failure. Without explicit convergence on a problem statement, teams develop solutions for vaguely understood problems. Force the team to articulate the problem in one sentence before opening the solution space.
- **Running the entire Double Diamond as one long convergent process with brief 'brainstorming breaks'** — Divergent phases should be substantial, not token gestures. If your Discover phase is a single stakeholder interview and your Develop phase is one 30-minute brainstorm, you're not actually diverging—you're just decorating a linear process with Double Diamond labels.
- **Assuming the Double Diamond is strictly linear with no iteration** — While the mode sequence (diverge→converge→diverge→converge) should be respected within each cycle, you may need to loop back. If convergence in Define reveals you lack sufficient understanding, return to Discover. The key is making these loops conscious and time-bounded rather than chaotic.
