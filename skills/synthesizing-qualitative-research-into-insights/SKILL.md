---
name: "synthesizing-qualitative-research-into-insights"
description: "Turn raw interviews and observation notes into clustered themes, patterns and tensions, and evidence-backed insight statements a team can design against."
category: "Experience"
metadata:
...
```mermaid
flowchart LR
  A[Raw field notes] --> B[Single observations]
  B --> C[Clustered themes]
  C --> D[Patterns and tensions]
  D --> E[Insight statements]
  E --> F{Evidence check}
  F -->|holds| G[Handoff to definition]
  F -->|thin| H[More fieldwork]
  H --> A
```
