---
name: "differentiating-transformational-from-transactional-leadership"
description: "Tell exchange-based transactional leadership apart from transformational leadership and combine both without losing clarity."
category: "Ops"
metadata:
...
```mermaid
flowchart LR
  A[Leader] --> B[Set terms of exchange]
  B --> C[Work delivered]
  C --> D[Reward or correction]
  A --> E[Engage values and needs]
  E --> F[Shared purpose]
  F --> G[Discretionary effort]
  D --> H[Team outcomes]
  G --> H
```
