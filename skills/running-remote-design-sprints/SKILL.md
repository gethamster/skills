...
| Time to Learn | 4-6 hours of preparation, plus a 4-5 day sprint execution |
...
This skill connects directly to several sibling skills in the sprint framework. You will draw on [planning and customizing your sprint agenda](https://tryhamster.com/skills/planning-design-sprint-agendas) to restructure timing, [facilitating workshops](https://tryhamster.com/skills/facilitating-design-sprint-workshops) for remote-specific moderation techniques, and [sketching and voting](https://tryhamster.com/skills/sketching-and-voting-on-solutions) for the exercises that need the most careful adaptation to digital tools.
...
### Step 1: Step 1: Audit Your Team's Distribution and Choose Your Sprint Schedule
...
> **Pro tip:** If your overlap window is tight, protect it aggressively. Cancel all non-sprint meetings for participants during sprint week. A participant who dips in and out of the synchronous block to attend a standup or a 1:1 creates context gaps that cascade through the rest of the day.

### Step 2: Step 2: Set Up the Digital War Room and Pre-Load All Templates
...
> **Pro tip:** Create a duplicate of the entire board as a backup before the sprint begins. Digital whiteboard tools occasionally have sync issues, and one accidental select-all-delete can wipe hours of work. A backup lets you restore quickly.

### Step 3: Step 3: Write Detailed Async Exercise Briefs for Every Solo Work Block
...
> **Pro tip:** Include a completed example in every brief. Show one finished sticky note, one completed sketch panel, or one Lightning Demo summary in the exact format you expect. Participants calibrate their output to the example far more reliably than to written instructions alone.

### Step 4: Step 4: Run a Pre-Sprint Kickoff Session to Align Context and Norms
...
> **Pro tip:** Agree on a single communication channel for sprint-related messages between sessions. A dedicated Slack channel or Teams channel prevents sprint conversations from getting buried in general threads. Pin the whiteboard link, the schedule, and the async brief links in this channel.

### Step 5: Step 5: Facilitate Day 1-2 with Structured Turn-Taking and Timer Discipline
...
> **Pro tip:** The silent working periods (Crazy 8s, individual sketching) can feel awkward on video. Normalize the silence by saying explicitly: "I'm going to mute and turn off my camera. You should too. I'll ring the timer when time is up." This permission to disconnect, even for 8 minutes, resets attention.

### Step 6: Step 6: Adapt Voting and Decision-Making for Asynchronous Equity
...
> **Pro tip:** If you have more than 8 sketches to review, break the Art Museum into two rounds. First round: everyone votes broadly across all sketches (3 dots each). Second round: the top 5 sketches get deeper review with the speed critique format. This prevents decision fatigue from reviewing too many concepts at full depth.

### Step 7: Step 7: Coordinate Prototype Building Across Distributed Contributors
...
> **Pro tip:** Archive the digital whiteboard in a shared team drive with a consistent naming convention (e.g., "Sprint-2024-Q3-Onboarding-Redesign"). Teams that run multiple sprints per year quickly lose track of prior sprint artifacts, and the whiteboard is the richest record of the team's thinking process.
...
- **Treating the digital whiteboard as optional or secondary, using slides or documents instead** — Slides and documents are linear and static. They cannot replicate the spatial memory of a war room wall where all artifacts are visible simultaneously. When a team uses a slide deck, each exercise output becomes buried in a sequence, and participants lose the holistic view that makes connections between the map, the HMW notes, and the solution sketches visible. Use a single whiteboard tool as the canonical sprint space.
