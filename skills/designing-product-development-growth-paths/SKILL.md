...
The work starts from customer jobs, and features come later. Clayton Christensen and his coauthors argue that product developers focus too much on customer profiles and correlations in data, and that successful innovators identify poorly performed jobs in customers' lives and design products, experiences and processes around them. They also note that jobs have social and emotional dimensions as well as functional ones ([HBR](https://hbr.org/2016/09/know-your-customers-jobs-to-be-done)). For an existing customer base, the richest source of such jobs is the work customers do just before and just after using your product.
