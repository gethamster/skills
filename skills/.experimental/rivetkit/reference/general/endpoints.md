...
1. Client caches these values and uses them for subsequent requests
2. Client connects to `https://api.rivet.dev/gateway/{actor}`, which routes requests to your actors
