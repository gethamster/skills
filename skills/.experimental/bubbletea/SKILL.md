...
- :crystal_ball: **Metaballs** - Lava lamp-style floating blobs
- :ocean: **Wave Effects** - Sine wave distortions
- :rainbow: **Rainbow Cycling** - Animated color gradients
- :performing_arts: **Layer Compositor** - ANSI-aware multi-layer rendering
...
### :cross_mark: DON'T: Set explicit Height() on bordered panels
