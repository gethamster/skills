---
name: "stimulating-intellectual-challenge"
description: "Get your team questioning assumptions and testing new approaches through bounded experiments, without losing execution discipline."
category: "Ops"
metadata:
...
```mermaid
flowchart LR
  A[Define problem] --> B[Describe future state]
  B --> C[Challenge assumptions]
  C --> D[Generate alternatives]
  D --> E[Run bounded experiment]
  E --> F[Learning review]
  F -->|next question| C
```
