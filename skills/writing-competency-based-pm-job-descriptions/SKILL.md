...
| Time to Learn | 2-3 hours for a complete job description |
...
### Step 1: Step 1: Confirm the Role's Quadrant Emphasis
...
> **Pro tip:** If every stakeholder picks a different quadrant, you may be trying to hire two roles in one. Split the role or explicitly decide which quadrant to deprioritize. A role that demands Level 4 across all four quadrants does not exist below the VP level.

### Step 2: Step 2: Select 4-6 Core Competencies
...
> **Pro tip:** Cross-reference your selections with the output from your team's gap analysis. If the team already has deep strength in data analysis, you may want to weight user research more heavily, even if both feel important.

### Step 3: Step 3: Set Proficiency Levels for Each Competency
...
> **Pro tip:** Refer to the sibling skill on defining competency levels from Associate PM to Senior PM for calibrated level descriptions. Borrowing from that calibration ensures your Level 3 means the same thing across every job description your team publishes.

### Step 4: Step 4: Write Responsibilities as Observable Behaviors
...
> **Pro tip:** Read each responsibility aloud and ask: 'Could a candidate show me evidence of doing this in a portfolio review or a case study?' If the answer is no, the statement is still too abstract.

### Step 5: Step 5: Rewrite Requirements as Demonstrated Behaviors, Not Credentials
...
> **Pro tip:** Run a quick check: would a self-taught PM with strong demonstrated competencies pass your requirements? If not, you have credential proxies masquerading as competency requirements.

### Step 6: Step 6: Add Evaluation Criteria for the Hiring Panel
...
> **Pro tip:** Assign each interviewer a primary competency to own. Overlap is fine on one or two competencies for calibration, but every competency must have at least one designated evaluator.

### Step 7: Step 7: Write the Role Summary Last
...
> **Pro tip:** The summary is the section most candidates read to decide whether to keep reading. Test it by showing it to someone unfamiliar with the role. If they cannot explain what the person will do day-to-day after reading those four sentences, revise.

### Step 8: Step 8: Review Against the Framework for Consistency
...
> **Pro tip:** Keep a one-page 'role profile card' alongside the description that lists the competency names, levels, and quadrant in a simple table. This card is the source of truth. If the prose ever contradicts the card, the prose needs editing.
