---
name: "defining-product-outcomes-over-outputs"
description: "Replace feature roadmaps with measurable behavior-change goals that give product teams room to discover solutions and stay accountable to results."
category: "Product"
metadata:
...
Within [Continuous Discovery Habits](https://tryhamster.com/methods/continuous-discovery-habits), the product outcome serves as the root node of the [opportunity solution tree](https://tryhamster.com/skills/building-opportunity-solution-trees). Every opportunity the team discovers through [customer interviews](https://tryhamster.com/skills/conducting-weekly-customer-interviews) is evaluated against its potential to move the outcome. Every solution is assessed by whether it addresses an opportunity that matters for the outcome. Every [assumption test](https://tryhamster.com/skills/running-assumption-tests) is designed to reduce risk around a solution that could move the outcome. Without a clear outcome, the tree has no root, and the team has no basis for prioritization.
...
Place your product outcome at the top of your [opportunity solution tree](https://tryhamster.com/skills/building-opportunity-solution-trees). This is where the outcome becomes operational rather than aspirational. Every opportunity you identify through [customer interviews](https://tryhamster.com/skills/conducting-weekly-customer-interviews) should be evaluated by asking: "If we addressed this opportunity, would it plausibly move our product outcome?" This doesn't mean every opportunity must have a direct, quantifiable link, some connections are indirect.

But there should always be a coherent argument connecting the opportunity to the outcome. If an opportunity has no plausible connection, it belongs in a parking lot for future consideration, not in your active tree. Similarly, when you're [running assumption tests](https://tryhamster.com/skills/running-assumption-tests) or [comparing solutions](https://tryhamster.com/skills/comparing-solutions-with-compare-and-contrast), the outcome provides the evaluative lens: which solution has the highest potential to move this metric?
...
- [Rethinking Product Discovery with Justice, Equity, Diversity, and](https://producttalk.org/design-justice)
...
- [Continuous Discovery Habits - Rohit Laukamp](https://rohitlaukamp.com/book-notes/continuous-discovery-habits)
